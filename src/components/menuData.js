export const menuData = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Profile Evaluation & University Shortlisting",
        url: "/services/profile-evaluation",
      },
      {
        name: "Statement of Purpose (SOP) / Essay Drafting",
        url: "/services/sop-essay-drafting",
      },
      { name: "Common Essay", url: "/services/common-essay" },
      { name: "Scholarship Guidance", url: "/services/scholarship-guidance" },
      {
        name: "Complete Application Help",
        url: "/services/complete-application-help",
      },
      {
        name: "Financial Documentation",
        url: "/services/financial-documentation",
      },
      { name: "Visa Documentation", url: "/services/visa-documentation" },
      { name: "Visa Application", url: "/services/visa-application" },
      { name: "Quick Appointment", url: "/services/quick-appointment" },
      { name: "Health Insurance", url: "/services/health-insurance" },
      { name: "Student Accommodation", url: "/services/student-accommodation" },
      {
