...
const services = [
  {
    ...
    desc: "We review your raw financial records to identify missing links, inconsistent dates, or weak evidence before you submit.",
  },
  {
    icon: PenTool,
    title: "Source of Funds Drafting",
    desc: "We help draft professional explanatory letters that clarify large deposits, irregular income, or complex family finances.",
  },
  {
    icon: Scale,
    title: "Sponsorship Structuring",
    desc: "Guidance on selecting the right sponsor (parents vs. relatives) and preparing the legal affidavits required to prove their commitment.",
  },
  {
    icon: FileCheck,
    title: "Bank Statement Formatting",
    desc: "Ensuring your bank certificates and statements meet the specific 'holding period' and format requirements of each embassy.",
  },
  {
    icon: Briefcase,
    title: "Business Document Review",
    desc: "For self-employed sponsors, we verify trade licenses, MOA/AOA, and tax returns to ensure they align with bank deposits.",
  },
  {
    icon: ShieldCheck,
    title: "Pre-Submission Audit",
    desc: "A final rigorous check of every page, stamp, and signature to prevent rejection due to technical or clerical errors.",
  },
];
...
const documentTypes = [
  {
    ...
    desc: "The core of your visa application. Includes bank statements, fixed deposit receipts, and loan sanction letters showing liquid funds.",
    color: "#005B8F",
  },
  {
    icon: TrendingUp,
    title: "Income Verification",
    desc: "Proof that your sponsor earns enough to support you. Includes salary certificates, pay slips, and Income Tax Returns (ITR).",
    color: "#16a34a",
  },
  {
    icon: Home,
    title: "Asset Valuation",
    desc: "Supplementary proof of wealth. Includes property deeds, land valuation reports, and car registration papers to show ties to home.",
    color: "#9333ea",
  },
  {
    icon: Users,
    title: "Sponsorship Affidavits",
    desc: "Legal notarized documents where sponsors formally declare their financial responsibility for your tuition and living costs.",
    color: "#d97706",
  },
  {
    icon: Briefcase,
    title: "Business Records",
    desc: "For business-owning families: Trade licenses, chamber memberships, and audited balance sheets to prove business legitimacy.",
    color: "#dc2626",
  },
  {
    icon: Stamp,
    title: "Legal & Identity Papers",
    desc: "Passports, birth certificates, marriage certificates (for spouse visas), and police clearance certificates.",
    color: "#4A83F3",
  },
];
...
const process = [
  {
    ...
    desc: "You share your raw financial and academic records. We organize them into a structured digital folder system.",
  },
  {
    step: 2,
    icon: Search,
    title: "Compliance Check",
    desc: "We cross-reference every document against the latest embassy checklist for your specific country and visa type.",
  },
  {
    step: 3,
    icon: PenTool,
    title: "Drafting Explanations",
    desc: "We write cover letters and source-of-funds explanations to clarify any complex financial transactions or gaps.",
  },
  {
    step: 4,
    icon: FileCheck,
    title: "Formatting & Translation",
    desc: "Non-English documents are professionally translated. All files are formatted to meet embassy size and clarity standards.",
  },
  {
    step: 5,
    icon: ShieldCheck,
    title: "Final Verification",
    desc: "A senior counselor reviews the entire package to ensure consistency between forms, letters, and financial proofs.",
  },
  {
    step: 6,
    icon: CheckCircle,
    title: "Submission Ready",
    desc: "You receive a final, indexed PDF package ready for upload or physical submission at the visa center.",
  },
];

const eligibilityItems = [
  "Funds must be 'liquid' (accessible cash) for most countries",
  "Sponsor must have a steady income history (usually 1-2 years)",
  "Source of funds must be legal and traceable (no unexplained cash)",
  ...
  "Documents must be recent (usually within last 3-6 months)",
];
...
const commonMistakes = [
  ...
  "Submitting blurry or cropped scans of important pages",
  "Forgetting to include previous years' tax returns",
];

const faqs = [
  {
    q: "How much money do I need to show in my bank account?",
